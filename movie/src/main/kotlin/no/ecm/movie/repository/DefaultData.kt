...
class DefaultData(
    ...
    fun createDefault(){
        ...
        val nowPlaying2 = NowPlaying(null, movie2, 4,1, ZonedDateTime.now().plusDays(1), mutableSetOf("A1", "A2", "B1", "D4", "A7", "A5", "D2"))
        val nowPlaying3 = NowPlaying(null, movie3, 5, 1,ZonedDateTime.now().plusDays(3), mutableSetOf("A2", "B1", "A3", "C2", "D4", "A7"))
        val nowPlaying4 = NowPlaying(null, movie4, 6, 2,ZonedDateTime.now().plusDays(8), mutableSetOf("B1", "A3", "C2", "D4", "A7", "A5", "D2"))
        val nowPlaying5 = NowPlaying(null, movie5, 6, 2,ZonedDateTime.now().plusDays(6), mutableSetOf("A2", "B1", "A3", "C2", "D4", "A7"))
        val nowPlaying6 = NowPlaying(null, movie6, 7, 3,ZonedDateTime.now().plusDays(2), mutableSetOf("A1", "A2", "B1"))
