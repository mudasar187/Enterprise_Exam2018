...
class DefaultData(
    ...
    fun createDefault(){
        ...
        val movie1 = Movie(null, "Inception", "https://m.media-amazon.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5BanBnXkFtZTcwNTI5OTM0Mw@@._V1_SX300.jpg",  mutableSetOf(action.name!!), 120, 13)
        val movie2 = Movie(null, "Isle of Dogs", "https://m.media-amazon.com/images/M/MV5BMTYyOTUwNjAxM15BMl5BanBnXkFtZTgwODcyMzE0NDM@._V1_SX300.jpg",  mutableSetOf(action.name!!), 90, 15)
        val movie3 = Movie(null, "Avengers: Infinity War", "https://m.media-amazon.com/images/M/MV5BMjMxNjY2MDU1OV5BMl5BanBnXkFtZTgwNzY1MTUwNTM@._V1_SX300.jpg",  mutableSetOf(adventure.name!!), 84, 18)
        val movie4 = Movie(null, "Batman: The Dark Knight", "https://m.media-amazon.com/images/M/MV5BMTMxNTMwODM0NF5BMl5BanBnXkFtZTcwODAyMTk2Mw@@._V1_SX300.jpg",  mutableSetOf(action.name!!, scifi.name!!), 105, 7)
        val movie5 = Movie(null, "The Hateful Eight", "https://m.media-amazon.com/images/M/MV5BMjA1MTc1NTg5NV5BMl5BanBnXkFtZTgwOTM2MDEzNzE@._V1_SX300.jpg",  mutableSetOf(scifi.name!!), 98, 15)
        val movie6 = Movie(null, "Django Unchained", "https://m.media-amazon.com/images/M/MV5BMjIyNTQ5NjQ1OV5BMl5BanBnXkFtZTcwODg1MDU4OA@@._V1_SX300.jpg",  mutableSetOf(scifi.name!!, adventure.name!!), 100, 10)
        val movie7 = Movie(null, "Star Wars: Episode IV - A New Hope", "https://m.media-amazon.com/images/M/MV5BNzVlY2MwMjktM2E4OS00Y2Y3LWE3ZjctYzhkZGM3YzA1ZWM2XkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_SX300.jpg",  mutableSetOf(action.name!!, adventure.name!!), 85, 7)
